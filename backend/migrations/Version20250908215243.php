 ...
 */
final class Version20250908215243 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE piece_jointe (id INT AUTO_INCREMENT NOT NULL, etat_lieu_id INT NOT NULL, url_fichier VARCHAR(255) NOT NULL, description LONGTEXT DEFAULT NULL, INDEX IDX_AB5111D46D6D2C49 (etat_lieu_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
