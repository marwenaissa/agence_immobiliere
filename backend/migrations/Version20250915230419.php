 ...
 */
final class Version20250915230419 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE operation_bien (id INT AUTO_INCREMENT NOT NULL, bien_id INT NOT NULL, client_id INT DEFAULT NULL, proprietaire_id INT DEFAULT NULL, type VARCHAR(20) NOT NULL, date_debut DATETIME DEFAULT NULL COMMENT \'(DC2Type:datetime_immutable)\', date_fin DATETIME DEFAULT NULL COMMENT \'(DC2Type:datetime_immutable)\', date_operation DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', montant NUMERIC(10, 2) NOT NULL, caution NUMERIC(10, 2) DEFAULT NULL, statut VARCHAR(20) NOT NULL, commentaire LONGTEXT DEFAULT NULL, INDEX IDX_6A9D9E17BD95B80F (bien_id), INDEX IDX_6A9D9E1719EB6921 (client_id), INDEX IDX_6A9D9E1776C50E4A (proprietaire_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE visite (id INT AUTO_INCREMENT NOT NULL, bien_id INT NOT NULL, relation_id INT NOT NULL, date_programmee DATETIME NOT NULL, statut VARCHAR(50) NOT NULL, commentaire LONGTEXT DEFAULT NULL, INDEX IDX_B09C8CBBBD95B80F (bien_id), INDEX IDX_B09C8CBB3256915B (relation_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE operation_bien ADD CONSTRAINT FK_6A9D9E1719EB6921 FOREIGN KEY (client_id) REFERENCES client (id)');
        $this->addSql('ALTER TABLE operation_bien ADD CONSTRAINT FK_6A9D9E1776C50E4A FOREIGN KEY (proprietaire_id) REFERENCES proprietaire (id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE operation_bien DROP FOREIGN KEY FK_6A9D9E1719EB6921');
        $this->addSql('ALTER TABLE operation_bien DROP FOREIGN KEY FK_6A9D9E1776C50E4A');
